...
08:37 KST 당시 66개 중 설계 4개 완료/62개 미완료, G0 미인수였다. 같은 날 후속으로 P0.06 을 운영 요청 로그 실측으로 인수해 5개 완료/61개 미완료다(KDB_API_COMPATIBILITY_CASES.md §실사용 확인). G0 는 여전히 미인수.
...
전체66항목 중 완료 체크5개(P0.01/P0.03/P0.04/P0.06/P0.07), 나머지61개 미완료다. 완료는 설계 산출물이며 구현/운영 완료 아님.
