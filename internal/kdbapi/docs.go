...
영문명으로). 그 근거를 떼고 칸을 비웠으며, 같은 대상인데 유형이 틀린 것은 유형을 고쳤습니다.<br>
<b>답하지 못하던 요청어를 등록했습니다.</b> 최근 7일 prepare 이름의 33% 가 «검수 대기» 로 멈춰 조회되지 않았습니다.
1,100여 건을 등록·활성화했고, 이제 이 판정을 30분마다 자동으로 합니다 — 전에 <code>review</code>·<code>preparing</code> 으로
받으신 이름을 다시 조회하시면 답이 나올 수 있습니다. 유형을 고친 대상(약 400건)이 있어 <code>type</code> 으로 좁힌 조회는
결과가 달라질 수 있습니다.
</td></tr>
