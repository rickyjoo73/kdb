...
var typeCues = map[string][]string{
	...
	// ── 정치·경제·시사·스포츠 (0143, 운영자 결정 2026-09-15).
	//    이 단서들이 없으면 새 유형이 `missing_type_context_cue` 로 검토에 쌓인다.
	"political_party": {"정당", "여당", "야당", "원내", "당대표", "창당", "비례대표"},
	"government_body": {"부처", "청", "위원회", "공단", "공사", "공공기관", "정부", "지자체", "시청", "도청", "국회", "법원", "검찰"},
	"company":         {"기업", "회사", "법인", "주식회사", "㈜", "그룹사", "계열사", "상장", "코스피", "코스닥"},
	"organization":    {"협회", "재단", "단체", "학회", "노조", "조합", "연맹", "사단법인", "재단법인"},
	"sports_team":     {"구단", "프로팀", "국가대표팀", "선수단", "FC", "유나이티드", "이글스", "라이온즈", "베어스", "타이거즈"},
	"school":          {"학교", "대학", "대학교", "고등학교", "중학교", "초등학교", "캠퍼스", "대학원"},

	// ── 기각 더미에서 실제로 들어오던 것들 (0146)
	"game":         {"게임", "모바일게임", "온라인게임", "출시", "업데이트", "패치", "서버", "길드", "던전", "RPG", "MMORPG", "넥슨", "엔씨", "넷마블", "크래프톤", "펄어비스", "스마일게이트"},
	"musical_play": {"뮤지컬", "연극", "공연", "무대", "초연", "재연", "넘버", "배역", "극장", "예술의전당", "블루스퀘어"},
	"webtoon":      {"웹툰", "웹소설", "만화", "연재", "작화", "네이버웹툰", "카카오페이지", "레진", "원작"},
	"publication":  {"잡지", "월간", "주간", "화보", "표지", "도서", "출간", "단행본", "출판사"},
}
